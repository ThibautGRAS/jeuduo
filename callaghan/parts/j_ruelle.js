...
const CANONS = {
  ...
  /* REMESURÉES sur les nouveaux sprites de PF. Les anciennes valeurs
     venaient de la planche précédente : la flamme partait à côté du canon,
     et pour `vise` elle tombait carrément dans le vide au-dessus de
     l'arme — vérifié en dessinant un repère sur le sprite.
     Écart relevé jusqu'à 15 % de la largeur, soit une cinquantaine de
     pixels à l'écran.

     La mesure : le pixel sombre le plus AVANCÉ, dans une zone ALLONGÉE.
     L'allongement compte — mes premières mesures tombaient sur les
     CHAUSSURES, brunes et sombres elles aussi, ce qui donnait des y à
     0,77 soit au niveau des pieds. Un canon est une barre, une chaussure
     est un pâté. */
  pf: {
    accroupi:[0.632, 0.487], arme1:[0.557, 0.449], arme2:[0.579, 0.423],
    baisse:[0.673, 0.456],   fumee:[0.812, 0.169], leve1:[0.654, 0.216],
    leve2:[0.809, 0.119],    recul1:[0.623, 0.181], recul2:[0.654, 0.176],
    tir:[0.825, 0.166],      vise:[0.801, 0.166],
  },
};
