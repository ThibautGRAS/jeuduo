...
const Sons = {
  ...
  ECHANTILLONS:[
    "tir_revolver", "tir_fusil", "recharge", "impact_chair",
  ...
  impact(tete){
    /* La tête garde son timbre propre : c'est la récompense, elle doit
       rester distincte même quand l'échantillon de chair est présent. */
    this.echant("impact_chair", tete ? 0.9 : 0.72, () => {
      this.claque(tete ? 0.09 : 0.10, tete ? 0.34 : 0.26,
                  tete ? 3000 : 1200, tete ? 300 : 180, tete ? 1.4 : 1.0);
    });
    if (tete) this.bip(420, 0.07, "triangle", 0.20, 180);
  },
