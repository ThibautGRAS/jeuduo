...
const INDICES = [
  ...
  { id:"collier", sprite:"ind_collier", nom:"Collier de chat",
    analyse:"Détaché à la boucle. Personne ne l'a arraché.", brut:"Un collier avec une médaille.",
  ...
  { id:"souris", sprite:"ind_souris", nom:"Souris en peluche",
    analyse:"Retrouvée loin de son panier. Portée, pas jouée.", brut:"Une souris en tissu.",
  ...
  { id:"loto", sprite:"ind_loto", nom:"Grille de loto",
    analyse:"Cochée au stylo. Le même stylo que le carnet.", brut:"Une grille avec des croix.",
  ...
  { id:"de", sprite:"ind_de", nom:"Dé à six faces",
    analyse:"Un seul. Il en manque cinq autres.", brut:"Un dé.",
  ...
  { id:"cartes", sprite:"ind_cartes", nom:"Jeu de cartes",
    analyse:"Éparpillées. La partie s'est arrêtée d'un coup.", brut:"Des cartes par terre.",
  ...
  { id:"chaussette", sprite:"ind_chaussette", nom:"Chaussette dépareillée",
    analyse:"De sport, tachée. Sans sa jumelle.", brut:"Une chaussette.",
  ...
  { id:"bouchon", sprite:"ind_bouchon", nom:"Bouchon de liège",
    analyse:"Percé deux fois. On s'y est repris.", brut:"Un bouchon.",
  ...
  { id:"tarte_part", sprite:"ind_tarte_part", nom:"Part de tarte entamée",
    analyse:"Tarte au citron. Une bouchée, pas plus.", brut:"Un morceau de tarte.",
  ...
  { id:"lunettes_noires", sprite:"ind_lunettes_noires", nom:"Lunettes de soleil",
    analyse:"Pliées, posées à l'intérieur. À 22 h.", brut:"Des lunettes noires.",
  ...
  { id:"pq", sprite:"ind_pq", nom:"Rouleau de papier toilette",
    analyse:"Neuf, hors des toilettes, entamé de deux feuilles.", brut:"Un rouleau de papier.",
  ...
  { id:"echarpe_tri", sprite:"ind_echarpe_tri", nom:"Écharpe tricolore",
    analyse:"Écharpe de maire. Absente il y a une heure.", brut:"Une écharpe bleu blanc rouge.",
