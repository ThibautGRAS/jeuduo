...
const Ruelle = {
  ...
  VAGUES:[
    ...
    { nombre:6,  delai:1.7,  vitesse:1.02, types:["abbe"] },
    /* La combinaison qui fait tout le niveau : un mur de Depardiahree
       protège le corps de l'Abbé mais pas la cible sur son bras. Il faut
    ...
    /* La septième mélange les cinq : c'est la horde qui pose enfin la
       ...
       s'arrêtent en arrière, le tank sert de mur. */
    { nombre:22, delai:0.68, vitesse:1.40,
