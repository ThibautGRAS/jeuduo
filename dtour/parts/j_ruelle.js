...
Object.assign(RuelleVue, {
  dessinerHud(){
    ...
    poser("btn_croix", zm.x, zm.y, zm.r);
    poser("btn_pouce",
      zm.x + Ruelle.manche.dx * zm.r * 0.40,
      zm.y + Ruelle.manche.dy * zm.r * 0.40, zm.r * 0.30);
    ...
    if (recharge){
      ...
      poser("btn_anneau", zt.x, zt.y, zt.r * 1.06);
      ctx.restore();
    }
    ...
    ctx.fillText(h.balles + "/" + arme.chargeur, zt.x, zt.y + zt.r * 1.34);
    ctx.restore();
    ...
    poser("btn_changer", zb.x, zb.y, zb.r);
